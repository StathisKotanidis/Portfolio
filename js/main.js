...
(function ($) {
  ...
  $(function () {
    ...
    $(".cover").each(function (index, element) {
      $(this).css(
        "background-image",
        "url(" + $(this).find(".cover-image-holder img").attr("src") + ")"
      );
    });
    // ------------------------------
  ...
  function showProjectDetails(url) {
    ...
    // ajax : fill data
    p.empty().load(
      $.address.baseURL() + "/" + url + " .portfolio-single",
      function () {
        ...
        p.imagesLoaded(function () {
          ...
          if (Modernizr.csstransforms && Modernizr.csstransforms3d) {
            // modern browser
            p.removeClass("animated " + outAnimation + " " + inAnimation)
  ...
  function hideProjectDetails(forever, safeClose) {
    ...
    if (Modernizr.csstransforms && Modernizr.csstransforms3d) {
      // modern browser
      pActive
        .removeClass("animated " + inAnimation)
